...
Pod::Spec.new do |s|
  s.name         = "CustomWebView"
    s.version      = "1.0.0"
  s.summary      = "Custom web view is a custom view. I have made this to test and see the process of creating the pod for my sample libraries. asdvajgsvdghjvsadhvgas jhavdjvas"
